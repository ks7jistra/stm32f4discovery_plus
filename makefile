...
ifeq ($(STM32PLUS_Fn),$(filter $(STM32PLUS_Fn),STM32PLUS_F407 STM32PLUS_F405))
...
ifdef ROSSERIAL_PORT
SYNTHESIS_DEFS	+= -DROSSERIAL_PORT=$(ROSSERIAL_PORT)
endif
